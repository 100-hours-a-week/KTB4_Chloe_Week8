...
CREATE TABLE `comments` (
                            ...
                            `updated_at`	TIMESTAMP	NOT NULL	COMMENT '댓글 수정 일시',
                            `deleted_at`	TIMESTAMP	NOT NULL	COMMENT '댓글 삭제 일시'
);
...
CREATE TABLE `posts` (
                         ...
                         `is_edited`	BOOLEAN	NOT NULL	DEFAULT fasle	COMMENT '게시글 수정 여부',
...
CREATE TABLE `post_change_history` (
                                       `change_id`	BIGINT	NOT NULL	COMMENT '게시글 수정 이력 식별번호',
                                       `post_id`	BIGINT	NOT NULL	COMMENT '게시글 식별 번호',
...
CREATE TABLE `users` (
                         ...
                         `updated_at`	TIMESTAMP	NOT NULL	COMMENT '사용자 정보 수정 일시',
                         `deleted_at`	TIMESTAMP	NOT NULL	COMMENT '사용자 탈퇴 일시'
);

CREATE TABLE `post_report_history` (
                                       `report_id`	BIGINT	NOT NULL	COMMENT '게시글 신고 식별 번호',
                                       `post_id`	BIGINT	NOT NULL	COMMENT '게시글 식별 번호',
                                       `user_id`	BIGINT	NOT NULL	COMMENT '사용자 식별 번호',
                                       `total_report_count`	TINYINT	NOT NULL	COMMENT '게시글 누적 신고 횟수',
